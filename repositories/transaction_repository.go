...
func (repo *TransactionRepository) CreateTransaction(items []models.CheckoutItem) (*models.Transaction, error) {
	...
	//inisialisai subtotal -> jumlah total keseluruhan
	totalAmount := 0
	//inisialiai modeling transactionDetail -> inset ke DB
	...
	for _, item := range items {
		...
		//hitung cuttent total = quantity * pricing
		//tambahkan kedalam subtotal
		...
		//item nya di masukin ke transactionDetails
	...
	for i, detail := range details {
		...
		_, err = tx.Exec("INSERT INTO transaction_details (transaction_id, product_id, quantity, subtotal) VALUES ($1, $2, $3, $4)",
			transactionID, detail.ProductID, detail.Qauntity, detail.Subtotal)
		if err != nil {
			return nil, err
		}
	}
